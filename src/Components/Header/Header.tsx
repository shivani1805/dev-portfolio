  ...
  return (
    ...
    <div className="backdrop" onClick={() => setIsMenuOpen(false)}></div>
      <header className='primary-header'>
        ...
        <a href="https://dev-portfolio-img.s3.us-east-2.amazonaws.com/shivani-sharma-Resume-NEU-Latest.pdf" target='_blank'  rel="noopener noreferrer" className="component-link resume-btn">
        Resume
        </a>
