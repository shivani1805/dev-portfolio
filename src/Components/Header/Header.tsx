  ...
  return (
    ...
    <div className="backdrop" onClick={() => setIsMenuOpen(false)}></div>
      <header className='primary-header'>
        ...
        <a href="https://ssharma-portfolio-assets.s3.us-east-1.amazonaws.com/Shivani-Sharma-SDE.pdf" target='_blank'  rel="noopener noreferrer" className="component-link resume-btn">
        Resume
        </a>
